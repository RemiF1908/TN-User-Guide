...
echo "📝 Création du Guide-Complet-TN.md fusionné..."
head -n 7 Contribuer.md > Guide-Complet-TN.md
...
for md_file in *.md; do
    ...
    if [ "$md_file" != "Guide-Complet-TN.md" ] && [ "$md_file" != "Contribuer.md" ] && [ "$md_file" != "*.md" ]; then
...
echo "✅ Guide-Complet-TN.md généré avec succès !"
echo "📊 Taille du fichier: $(wc -l < Guide-Complet-TN.md) lignes"
